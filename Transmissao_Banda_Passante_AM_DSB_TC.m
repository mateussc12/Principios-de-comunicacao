% =========================================================================
% 
%                      TRANSMISSAO BANDA PASSANTE AM-DSB/TC
%
% =========================================================================
...
max_amp_x = abs(max(x)); % Máxima amplitude 
amp_portadora = 1.5 * max_amp_x; % Amplitude da portadora

% Modulucao da portadora (em AM)
y = ammod(x,Fc,Fs_bp,fase_ini,amp_portadora);
...
% Demodulacao
z = amdemod(y_ruidoso,Fc,Fs_bp,fase_ini,amp_portadora);
